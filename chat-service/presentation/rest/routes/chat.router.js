...
export const createChatRoutes = ({ chatController }) => {
  ...
  router.post(
    ...
    chatController.createDriverAdminChat
  );
  ...
  router.get(
    ...
    chatController.getDriverAdminChats
  );
  ...
  router.post(
    "/passenger-admin",
    authMiddleware(["admin", "passenger"]),
    chatController.createPassengerAdminChat
  );
  ...
  router.get(
    "/passenger-admin",
    authMiddleware(["passenger", "admin"]),
    chatController.getPassengerAdminChats
  );
